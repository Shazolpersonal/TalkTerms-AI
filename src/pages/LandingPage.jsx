      ...
      <main>
        ...
        <section className="relative pt-24 pb-32 text-center">
          ...
          <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <h1 className="text-5xl font-bold text-[#1F2937] leading-tight md:text-6xl">
              Confidence is your best counteroffer. We help you build it.
            </h1>
            <p className="mt-6 text-lg text-[--color-text-primary]">
          ...
          <section id="how-it-works" className="py-20 bg-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center">
                ...
                <p className="mt-4 text-lg text-[--color-text-primary]">Three simple steps to build your confidence.</p>
              </div>
              <div className="mt-12 grid gap-10 md:grid-cols-3">
                <div className="text-center">
                  ...
                  <p className="mt-2 text-base text-[--color-text-primary]">Securely upload your contract, job offer, or any negotiation document.</p>
                </div>
                <div className="text-center">
                  <div className="flex items-center justify-center h-12 w-12 rounded-lg bg-[--color-action-blue] text-white mx-auto">
                    {/* Icon Placeholder */}
                  ...
                  <p className="mt-2 text-base text-[--color-text-primary]">Our AI analyzes your text, highlighting key areas for improvement and suggesting stronger terms.</p>
                </div>
                <div className="text-center">
                  <div className="flex items-center justify-center h-12 w-12 rounded-lg bg-[--color-action-blue] text-white mx-auto">
                    {/* Icon Placeholder */}
                  ...
                  <p className="mt-2 text-base text-[--color-text-primary]">Walk into your negotiation with clear, actionable advice and the confidence to match.</p>
                </div>
              </div>
            </div>
          </section>
          ...
          <section id="confidence-corner" className="py-20 bg-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center">
                ...
                <p className="mt-4 text-lg text-[--color-text-primary]">Don't just take our word for it.</p>
              </div>
              <div className="mt-12 grid gap-10 md:grid-cols-3">
                {/* Testimonial 1 */}
                <div className="bg-[--color-clean-slate] p-6 rounded-lg">
                  <p className="text-[--color-text-primary]">"TalkTerms AI gave me the confidence to ask for a 20% raise, and I got it! The AI's suggestions were spot-on."</p>
                  <p className="mt-4 font-semibold text-[--color-text-primary]">- Sarah L., Software Engineer</p>
                </div>
                {/* Testimonial 2 */}
                <div className="bg-[--color-clean-slate] p-6 rounded-lg">
                  <p className="text-[--color-text-primary]">"As a freelancer, negotiating contracts is my least favorite part. This tool made it so much easier and I secured much better terms."</p>
                  <p className="mt-4 font-semibold text-[--color-text-primary]">- Mike R., Freelance Designer</p>
                </div>
                {/* Testimonial 3 */}
                <div className="bg-[--color-clean-slate] p-6 rounded-lg">
                  <p className="text-[--color-text-primary]">"I used it for a business deal and it caught a clause that would have cost us thousands. An absolute game-changer."</p>
              ...
              <div className="mt-16 flex justify-around text-center">
                  <div className="px-4">
                      <p className="text-4xl font-bold text-[--color-action-blue]">15%</p>
                       <p className="mt-2 text-base text-[--color-text-primary]">Average Salary Increase</p>
                  </div>
                  <div className="px-4">
                      <p className="text-4xl font-bold text-[--color-action-blue]">10,000+</p>
                       <p className="mt-2 text-base text-[--color-text-primary]">Successful Negotiations</p>
                  </div>
                  <div className="px-4">
                      <p className="text-4xl font-bold text-[--color-action-blue]">4.9/5</p>
                       <p className="mt-2 text-base text-[--color-text-primary]">User Satisfaction</p>
                  </div>
              </div>
            </div>
          </section>
